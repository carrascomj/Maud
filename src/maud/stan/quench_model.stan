...
generated quantities {
  ...
  array[N_experiment_train] vector[N_drain] drain_train_z = rep_array(rep_vector(
                                                                    std_normal_rng(
                                                                    ),
                                                                    N_drain),
                                                                    N_experiment_train);
  array[N_experiment_train] vector[N_enzyme] log_conc_enzyme_train_z = rep_array(rep_vector(
                                                                    std_normal_rng(
                                                                    ),
                                                                    N_enzyme),
                                                                    N_experiment_train);
  array[N_experiment_train] vector[N_pme] log_conc_pme_train_z = rep_array(rep_vector(
                                                                    std_normal_rng(
                                                                    ), N_pme),
                                                                    N_experiment_train);
  array[N_experiment_train] vector[N_unbalanced] log_conc_unbalanced_train_z = rep_array(rep_vector(
                                                                    std_normal_rng(
                                                                    ),
                                                                    N_unbalanced),
                                                                    N_experiment_train);
  ...
  for (e in 1 : N_experiment_train) {
    ...
    conc_quenched_experiment = ode_bdf_tol(dbalanced_dt,
